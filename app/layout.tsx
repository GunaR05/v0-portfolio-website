...
export const metadata: Metadata = {
  ...
  generator: 'v0.app',
  icons: {
    icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='15' fill='%230D1B2A'/><text y='.9em' font-size='75' x='12' font-family='Arial' font-weight='bold' fill='%2300C2FF'>G</text></svg>",
  },
}
