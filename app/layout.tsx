...
export const metadata: Metadata = {
  ...
  generator: 'v0.app',
  icons: {
    icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='15' fill='%23050505'/><text y='.9em' font-size='75' x='12' font-family='Courier New' font-weight='bold' fill='%2300FF41'>G</text></svg>",
  },
}
