      ...
      <AnimatePresence>
        {showButton && !isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-[60px] h-[60px] rounded-full bg-gradient-to-br from-[#00C2FF] to-[#7B61FF] flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow group"
