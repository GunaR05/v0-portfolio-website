    ...
    <>
      ...
      <AnimatePresence>
        {showBubble && showButton && !isOpen && (
          ...
          >
            <motion.div
              className={`bg-gradient-to-r from-[#0066FF] to-[#0066FF] text-white text-xs font-bold px-3 py-2.5 rounded-[12px] rounded-br-none shadow-lg whitespace-nowrap relative ${
      ...
      <AnimatePresence>
        {showButton && !isOpen && (
          <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-1.5">
            ...
            <span className="hidden sm:block text-[10px] text-[#7BA4C7] font-medium">
              Chat with Guna AI
            </span>
            ...
            <div className="relative">
              <motion.button
                ...
                onMouseEnter={() => setIsHovering(true)}
                onMouseLeave={() => setIsHovering(false)}
                className="w-[60px] h-[60px] rounded-full bg-gradient-to-br from-[#0066FF] to-[#0066FF] flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow group"
                aria-label="Open chat"
              >
                {/* Pulse animation ring */}
                <span className="absolute inset-0 rounded-full bg-gradient-to-br from-[#0066FF] to-[#0066FF] animate-ping opacity-30" />
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#0066FF] to-[#0066FF] px-4 py-3 flex items-center justify-between">
                ...
                >
                  <div
                    className={`max-w-[85%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
                      message.isUser
                        ? "bg-gradient-to-br from-[#0066FF] to-[#0066FF] text-white rounded-br-md"
            ...
            <div className="px-4 py-3 border-t border-border flex gap-2">
              ...
              <Button
                size="sm"
                className="flex-1 text-xs bg-gradient-to-r from-[#0066FF] to-[#0066FF] hover:opacity-90"
                asChild
              >
                <a href="#contact">
